...
**GitHub** is a tool that software developers use to store and manage code. It is a proprietary service owned by Microsoft, but it uses **git**, an open-source system that helps you track changes in source code.   When you start a project in GitHub, you create a *repository,* which you can update with changes that will be tracked automatically in GitHub. 
